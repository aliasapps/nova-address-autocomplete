...
Nova.booting(function (Vue, router) {
    Vue.component('index-address_autocomplete', __webpack_require__(3));
    Vue.component('detail-address_autocomplete', __webpack_require__(6));
    Vue.component('form-address_autocomplete', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    checkboxClassObject: function checkboxClassObject() {
      return {
...
*/
var BASIC_DATA_FIELDS = ['address_components', 'adr_address', 'alt_id', 'formatted_address', 'geometry', 'icon', 'id', 'name', 'permanently_closed', 'photo', 'place_id', 'scope', 'type', 'url', 'utc_offset', 'vicinity'];
    ...
    [
      _c("template", { slot: "field" }, [
        _c("div", { staticClass: "grid grid-cols-6" }, [
          _c("div", { class: _vm.checkboxClassObject }, [
            _c("input", {
              directives: [
                {
                  name: "model",
